...
%num_ne_data=24; %numcr of electron density in the data table
num_Te_data=30; %numcr of electron temperature in the data table

temp_n_e=dlmread('ccd96_c.dat','','A3..H5');  %read n_e datas of which number of column is eight(A~H).
n_e_data = (10^6)*10.^[temp_n_e(1,:),temp_n_e(2,:),temp_n_e(3,:)];
%remove log10 in the data by mulitiplication of 10^. 
%unit change by multiplication of (10^6) : [#/cm3->#/m3]
%write all the electron density data in one row.
temp_T_e=dlmread('ccd96_c.dat','','A6..H9');    %read T_e datas of which number of column is eight(A~H).  
T_e_data = 10.^[temp_T_e(1,:),temp_T_e(2,:),temp_T_e(3,:),temp_T_e(4,1:num_Te_data-24)];
%remove log10 in the data by mulitiplication of 10^. 
%write all the electron temperature data in one row.

tempdata_1=dlmread('ccd96_c.dat','','A11..H100'); %read coefficient datas of which number of column is eight(A~H).
for k=1:num_Te_data
     Table_CCD_C_1_0(k,:)=(10^-6)*10.^[tempdata_1(k*3-2,:),tempdata_1(k*3-1,:),tempdata_1(k*3,:)];
     %because every four rows have the same electron temperature in the raw data txt file, 
     %write all the coef datas whose Te is the same in the same one row.
     %remove log10 in the data by mulitiplication of 10^ 
     %unit change by multiplication of (10^-6) : [cm3/sec->m3/sec]
 ...
 tempdata_2=dlmread('ccd96_c.dat','','A102..H191');
for k=1:num_Te_data
     Table_CCD_C_2_1(k,:)=(10^-6)*10.^[tempdata_2(k*3-2,:),tempdata_2(k*3-1,:),tempdata_2(k*3,:)];
end

tempdata_3=dlmread('ccd96_c.dat','','A193..H282');
for k=1:num_Te_data
     Table_CCD_C_3_2(k,:)=(10^-6)*10.^[tempdata_3(k*3-2,:),tempdata_3(k*3-1,:),tempdata_3(k*3,:)];
end

tempdata_4=dlmread('ccd96_c.dat','','A284..H373');
for k=1:num_Te_data
     Table_CCD_C_4_3(k,:)=(10^-6)*10.^[tempdata_4(k*3-2,:),tempdata_4(k*3-1,:),tempdata_4(k*3,:)];
end

tempdata_5=dlmread('ccd96_c.dat','','A375..H464');
for k=1:num_Te_data
     Table_CCD_C_5_4(k,:)=(10^-6)*10.^[tempdata_5(k*3-2,:),tempdata_5(k*3-1,:),tempdata_5(k*3,:)];
end

tempdata_6=dlmread('ccd96_c.dat','','A466..H555');
for k=1:num_Te_data
     Table_CCD_C_6_5(k,:)=(10^-6)*10.^[tempdata_6(k*3-2,:),tempdata_6(k*3-1,:),tempdata_6(k*3,:)];
end
...
temp_n_e=dlmread('ccd96_d.dat','','A3..H5'); %read n_e datas of which number of column is eight(A~H).  
n_e_data = (10^6)*10.^[temp_n_e(1,:),temp_n_e(2,:),temp_n_e(3,:)];
%remove log10 in the data by mulitiplication of 10^. 
%unit change by multiplication of (10^6) : [#/cm3->#/m3]
%write all the electron density data in one row.
temp_T_e=dlmread('ccd96_d.dat','','A6..H9');   %read T_e datas of which number of column is eight(A~H).  
T_e_data = 10.^[temp_T_e(1,:),temp_T_e(2,:),temp_T_e(3,:),temp_T_e(4,1:5)];
%remove log10 in the data by mulitiplication of 10^. 
%write all the electron temperature data in one row.
tempdata_1=dlmread('ccd96_d.dat','','A11..H97');%read coefficient datas of which number of column is eight(A~H).
for k=1:num_Te_data
     Table_CCD_H_1_0(k,:)=(10^-6)*10.^[tempdata_1(3*k-2,:),tempdata_1(3*k-1,:),tempdata_1(k*3,:) ];
     %because every four rows have the same electron temperature in the raw data txt file, 
     %write all the coef datas whose Te is the same in the same one row.
     %remove log10 in the data by mulitiplication of 10^ 
     %unit change by multiplication of (10^-6) : [cm3/sec->m3/sec]
...
%% PLT_H
global n_e_data_PLT_H T_e_data_PLT_H Table_PLT_H_0;
...
temp_n_e=dlmread('prc96_c.dat','','A3..H5'); %read n_e datas of which number of column is eight(A~H).
n_e_data = (10^6)*10.^[temp_n_e(1,:),temp_n_e(2,:),temp_n_e(3,:)];
%remove log10 in the data by mulitiplication of 10^. 
%unit change by multiplication of (10^6) : [#/cm3->#/m3]
%write all the electron density data in one row.
temp_T_e=dlmread('prc96_c.dat','','A6..H9');  %read T_e datas of which number of column is eight(A~H).   
T_e_data = 10.^[temp_T_e(1,:),temp_T_e(2,:),temp_T_e(3,:),temp_T_e(4,1:num_Te_data-24)];
%remove log10 in the data by mulitiplication of 10^. 
%write all the electron temperature data in one row.

tempdata_1=dlmread('prc96_c.dat','','A11..H100');%read coefficient datas of which number of column is eight(A~H).
for k=1:num_Te_data
     Table_PRC_C_1_0(k,:)=(10^-6)*10.^[tempdata_1(k*3-2,:),tempdata_1(k*3-1,:),tempdata_1(k*3,:)];
     %because every four rows have the same electron temperature in the raw data txt file, 
     %write all the coef datas whose Te is the same in the same one row.
     %remove log10 in the data by mulitiplication of 10^
      %unit change by multiplication of (10^-6) : [cm3/sec->m3/sec]
 ...
 tempdata_2=dlmread('prc96_c.dat','','A102..H191');
for k=1:num_Te_data
     Table_PRC_C_2_1(k,:)=(10^-6)*10.^[tempdata_2(k*3-2,:),tempdata_2(k*3-1,:),tempdata_2(k*3,:)];
end

tempdata_3=dlmread('prc96_c.dat','','A193..H282');
for k=1:num_Te_data
     Table_PRC_C_3_2(k,:)=(10^-6)*10.^[tempdata_3(k*3-2,:),tempdata_3(k*3-1,:),tempdata_3(k*3,:)];
end

tempdata_4=dlmread('prc96_c.dat','','A284..H373');
for k=1:num_Te_data
     Table_PRC_C_4_3(k,:)=(10^-6)*10.^[tempdata_4(k*3-2,:),tempdata_4(k*3-1,:),tempdata_4(k*3,:)];
end

tempdata_5=dlmread('prc96_c.dat','','A375..H464');
for k=1:num_Te_data
     Table_PRC_C_5_4(k,:)=(10^-6)*10.^[tempdata_5(k*3-2,:),tempdata_5(k*3-1,:),tempdata_5(k*3,:)];
end

tempdata_6=dlmread('prc96_c.dat','','A466..H555');
for k=1:num_Te_data
     Table_PRC_C_6_5(k,:)=(10^-6)*10.^[tempdata_6(k*3-2,:),tempdata_6(k*3-1,:),tempdata_6(k*3,:)];
end
...
temp_n_e=dlmread('prc96_d.dat','','A3..H5'); %read n_e datas of which number of column is eight(A~H). 
n_e_data = (10^6)*10.^[temp_n_e(1,:),temp_n_e(2,:),temp_n_e(3,:)];
%remove log10 in the data by mulitiplication of 10^. 
%unit change by multiplication of (10^6) : [#/cm3->#/m3]
%write all the electron density data in one row.
temp_T_e=dlmread('prc96_d.dat','','A6..H9');   %read T_e datas of which number of column is eight(A~H).  
T_e_data = 10.^[temp_T_e(1,:),temp_T_e(2,:),temp_T_e(3,:),temp_T_e(4,1:num_Te_data-24)];
%remove log10 in the data by mulitiplication of 10^. 
%write all the electron temperature data in one row.

tempdata_1=dlmread('prc96_d.dat','','A11..H97');%read coefficient datas of which number of column is eight(A~H).
for k=1:num_Te_data
     Table_PRC_H_1_0(k,:)=(10^-6)*10.^[tempdata_1(3*k-2,:),tempdata_1(3*k-1,:),tempdata_1(3*k,:) ];
     %because every three rows have the same electron temperature in the raw data txt file, 
     %write all the coef datas whose Te is the same in the same one row.
     %remove log10 in the data by mulitiplication of 10^ 
     %unit change by multiplication of (10^-6) : [cm3/sec->m3/sec]
